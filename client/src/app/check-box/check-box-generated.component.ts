/*
  ...
  Modify check-box.component.ts instead.
*/
...
export class CheckBoxGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  @ViewChild('checkbox0') checkbox0: CheckBoxComponent;
