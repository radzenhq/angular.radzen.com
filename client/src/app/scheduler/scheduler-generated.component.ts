/*
  ...
  Modify scheduler.component.ts instead.
*/
...
export class SchedulerGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    this.northwind.getNorthwindOrders(null, null, null, null, `Customer`, null)
