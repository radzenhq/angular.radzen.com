/*
  ...
  Modify gravatar.component.ts instead.
*/
...
export class GravatarGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  @ViewChild('gravatar1') gravatar1: GravatarComponent;
