/*
  ...
  Modify rating.component.ts instead.
*/
...
export class RatingGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  @ViewChild('rating0') rating0: RatingComponent;
  @ViewChild('heading3') heading3: HeadingComponent;
  @ViewChild('rating1') rating1: RatingComponent;
