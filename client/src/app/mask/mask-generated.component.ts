/*
  ...
  Modify mask.component.ts instead.
*/
...
import { MaskComponent } from '@radzen/angular/dist/mask';
import { HtmlComponent } from '@radzen/angular/dist/html';

import { ConfigService } from '../config.service';


export class MaskGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  @ViewChild('mask0') mask0: MaskComponent;
  @ViewChild('heading3') heading3: HeadingComponent;
  @ViewChild('mask1') mask1: MaskComponent;
  @ViewChild('heading4') heading4: HeadingComponent;
  @ViewChild('mask2') mask2: MaskComponent;
