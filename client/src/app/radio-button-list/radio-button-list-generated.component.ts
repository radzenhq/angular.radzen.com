/*
  ...
  Modify radio-button-list.component.ts instead.
*/
...
export class RadioButtonListGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  @ViewChild('radiobuttonlist1') radiobuttonlist1: RadioButtonListComponent;
