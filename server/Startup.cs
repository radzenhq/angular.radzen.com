...
namespace RadzenAngularComponents
{
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new RadzenAngularComponents.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new RadzenAngularComponents.Data.XlsDataContractSerializerOutputFormatter());
      });
